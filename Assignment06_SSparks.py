...
# SSparks,5.16.21, began modifying code to complete assignment 6
# SSparks,5.17.21, continued completing assignment 6
# SSparks,5.18.21, tested and finalized for submission
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def write_data_to_file(file_name, list_of_rows):
        ...
        for row in list_of_rows:
            file.write(row["Task"] + "," + row["Priority"].strip() + "\n")
        file.close()
        return list_of_rows, 'Success'
...
while(True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        Processor.remove_data_from_list(IO.input_task_to_remove(lstTable), lstTable)
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu
    ...
    elif strChoice == '5':  # Show Current Data
